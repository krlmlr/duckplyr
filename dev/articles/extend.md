...
#> directory: ℹ /tmp/RtmpD2fGO8/duckdb This is removed when the R session
...
#> the temporary directory (and silence this message). ℹ See
#> ?duckdb_storage for details and alternatives.
#> Joining with `by = join_by(mpg)`
#> [[1]]
#>   mpg cyl disp  hp
#> 1  21   6  160 110
