...
#> ℹ /tmp/Rtmp5n9Xgg/duckdb/extensions
...
dbplyr_data
#> # A query:  ?? x 2
#> # Database: DuckDB 1.5.4 [unknown@Linux 7.0.0-1009-azure:R 4.6.1//tmp/Rtmp5n9Xgg/file3a6f19bf8aad.duckdb]
#>       x y    
#>   <int> <chr>
#> 1     1 a    
#> 2     2 b    
