...
it is sufficient to prefix all calls to duckplyr functions with `duckplyr::` and not attach the package.
...
Learn more about prudence in `vignette("prudence")`, about fallbacks to dplyr in `vignette("fallback")`,
about the translation employed by duckplyr in `vignette("limits")`, about direct use of DuckDB functions in `vignette("duckdb")`,
